...
// Import CartItem model (if it is in another file)

class SayuranView extends GetView<SayuranController> {
  const SayuranView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    SayuranController controller = Get.find();

    return Scaffold(
      appBar: AppBar(
        title: const Text('Sayuran', style: TextStyle(fontSize: 16)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "Temukan Produk Sayuran Favorit Anda!",
            ...
            Expanded(
              child: Obx(() {
                return GridView.builder(
                  ...
                  itemCount: controller.sayuranList.length,
                  itemBuilder: (context, index) {
                    final product = controller.sayuranList[index];
                    return Card(
        ...
        onTap: (index) {
          switch (index) {
            case 0:
              ...
              break;
            case 1:
              Get.toNamed('/promo'); // Navigasi ke Promo
              break;
            case 2:
              Get.toNamed('/activity'); // Navigasi ke Activity
              break;
            case 3:
              Get.toNamed('/accounts'); // Navigasi ke Accounts
              break;
          }
        },
      ),
